 ...
 */
export async function GET_topRatedMovies(category = 'IMDB_TOP_50', page = 1, limit = 10) {
  try {
    const res = await fetch(
 ...
 */
export async function GET_movieReviews(movieId, page = 1, limit = 10, sort = 'newest') {
  try {
    const res = await fetch(
